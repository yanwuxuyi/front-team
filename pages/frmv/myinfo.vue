	...
	<view>
		<view>
			<u-navbar title-color="#fff" back-icon-color="#ffffff" :is-fixed="isFixed" :is-back="isBack"
				...
				:back-icon-name="backIconName" :back-text="backText" :border-bottom="false">
		...
		<view v-if="logined">
			<view class="top">
				<view class="background"
					style="background-image: linear-gradient(45deg, rgb(44, 168, 187), rgb(166, 197, 198));"></view>
			</view>
			<view class="user-card">
				<view class="card">
					<view class="top">
						<view class="userImage">
							<u-avatar v-if="gender==='男'" :src="pic" size="140" :showSex="true" sexIcon="man"
								mode="circle" sexBgColor="#71d5a1" @click="goSelectheadpic()"></u-avatar>
							<u-avatar v-else :src="pic" size="140" :showSex="true" sexIcon="woman" mode="circle"
								sexBgColor="#fab6b6" @click="goSelectheadpic()"></u-avatar>
						</view>
					</view>
					<view class="bottom">
						<view class="left">
		...
		<view>
			<u-modal ref="uModal" v-model="show" :show-cancel-button="true" :show-title="showTitle"
				:async-close="asyncClose" @confirm="sendscore(yonghu.studentId)" :content="content">
				<view style="margin: 60rpx; display: flex; justify-content: center;">
					<u-rate v-model="value" :count="5" :active-color="activeColor" :inaction-color="inactiveColor"
						:colors="colors" :icons="icons" :size="60"></u-rate>
				</view>
			</u-modal>
		</view>
	</view>
